...
#Efron Paduansi 04TPLP002 STMIK Eresha 19202
...
class applikasiKalkulator(tk.Tk):
    ...
    def membuatTombol(self):
        ...
        for penampung in btn_list:
            ...
            if penampung == '=':
                tk.Button(self, text='=', width=5, command=perintah).grid(row=baris, column=kolom, columnspan=5)
            else:
